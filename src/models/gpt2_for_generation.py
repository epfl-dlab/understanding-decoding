...
class GPT2LMHeadModelWithMCTSSupport(transformers.GPT2LMHeadModel, GenerationMixinWithGenericMCTSSupport):
    pass


class GPT2ForGeneration(pl.LightningModule):
    def __init__(
        self,
        ...
        **kwargs
        ...
        if from_checkpoint or random_initialization:
            ...
            self.model = GPT2LMHeadModelWithMCTSSupport(self.hparams.hf_config)
        else:
            self.model = GPT2LMHeadModelWithMCTSSupport.from_pretrained(**self.hparams.hf_model)
